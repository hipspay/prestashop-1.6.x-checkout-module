...
1. Download our latest PrestaShop 1.6.x Checkout module [here](https://github.com/hipspay/prestashop-1.6.x-checkout-module/releases).
2. Login to admin and go to Modules and Services.
3. Press the Add a new module in the top right corner and upload [HIPS.PS.x.x.x.Checkout.zip](https://github.com/hipspay/prestashop-1.6.x-checkout-module/releases). 
